...
const SURVEY_QUESTIONS = [
  ...
  'Dificultad para tragar, gases, dispepsia: dolor antes y después de comer, sensación de ardor, sensación de estómago lleno, vómitos acuosos, vómitos, sensación de estómago vacío, digestión lenta, borborigmos.'
];
...
// Array de memes/mensajes motivacionales (imágenes) de dominio libre o uso permitido
const MEME_IMAGES = [
  'https://images.pexels.com/photos/14356302/pexels-photo-14356302.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', // Imagen relajante
  'https://images.pexels.com/photos/8386712/pexels-photo-8386712.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', // Naturaleza serena
  'https://images.pexels.com/photos/4588047/pexels-photo-4588047.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', // Amanecer motivador
  'https://images.pexels.com/photos/4555613/pexels-photo-4555613.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', // Sonrisa inspiradora
  'https://images.pexels.com/photos/5256722/pexels-photo-5256722.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'  // Vista de montaña
];
...
const styles = StyleSheet.create({
  ...
  // Pantalla de encuesta completada
  completionCard: {
    backgroundColor: '#fff',
    margin: 20,
    padding: 20,
  ...
  // Meme (imagen motivacional) en la pantalla final
  memeImage: {
    width: 250,
    height: 150,
    borderRadius: 10,
